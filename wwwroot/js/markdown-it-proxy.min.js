...
var markdownItClass = function markdownitTagClass(md, mapping = {}) {
  md.core.ruler.push('markdownit-tag-class', state => {
    setTokenClasses(state.tokens, mapping);
  });
};

var markdownItHeaderSections = function headerSections(md) {
  function addSections(state) {
    ...
    function openSection(attrs) {
      ...
      t.block = true;
      t.attrs = attrs && attrs.map(function (attr) {
    ...
    for (var i = 0, l = state.tokens.length; i < l; i++) {
      var token = state.tokens[i]; // record level of nesting
...
const mdDict = {};
function init(options = {}, tagClassMap = {}, key = "default") {
    options = Object.assign(Object.assign({}, options), { highlight });
    const md = new markdownIt(options)
        .use(markdownItHeaderSections)
        .use(markdownItClass, tagClassMap);
    key !== null && key !== void 0 ? key : (key = "default");
    mdDict[key] = md;
}
function render(src, key = "default") {
    key !== null && key !== void 0 ? key : (key = "default");
...
function highlight(str, lang) {
    ...
    if (!highlighter) {
        console.warn(`[markdown-it-proxy] Highlighter(Prismjs or Highlight.js) is required!`);
        return str;
    }
    if (!lang) {
        return str;
    ...
    if (highlighter.getLanguage(lang)) {
        try {
            ...
            console.error(`[markdown-it-proxy] Syntax highlight for language ${lang} failed.`);
            return str;
        }
    }
    else {
